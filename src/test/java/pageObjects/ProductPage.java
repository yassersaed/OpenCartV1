...
public class ProductPage {
    ...
    public void addToCart() {
        try {
            wait.until(ExpectedConditions.elementToBeClickable(btnAddToCart)).click(); // Wait for add-to-cart button to be
        } catch (Exception e) {
    ...
    public boolean checkConfMsg() {
        try {
            wait.until(ExpectedConditions.visibilityOf(cnfMsg)).isDisplayed(); // Wait for confirmation message to be visible
            return true;
        } catch (Exception e) {
    ...
    public void clickItemsToNavigateToCart() {
        try {
            wait.until(ExpectedConditions.elementToBeClickable(btnItems)).click(); // Wait for the Items button to be clickable
        } catch (Exception e) {
    ...
    public ShoppingCartPage clickViewCart() {
        try {
            wait.until(ExpectedConditions.elementToBeClickable(lnkViewCart)).click(); // Wait for the View Cart link to be clickable
